...
class ApplicationPropertiesForm(forms.Form):
    ...
    DATASOURCE_DEFINITION_FILE = forms.CharField(required=False)
    ACTION_DEFINITION_FILE = forms.CharField(required=False)
    PG_HOST = forms.CharField(required=False)
    PG_PORT = forms.CharField(required=False)
    PG_DBNAME = forms.CharField(required=False)
    PG_USER = forms.CharField(required=False)
    PG_PASS = forms.CharField(required=False)
    PG_DSN = forms.CharField(required=False)
